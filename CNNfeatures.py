...
if __name__ == "__main__":
    ...
    if args.database == 'CVD2014':
        ...
        videos_dir='/home/jovyan/VSFA/Code/CVD2014/'
    ...
    if args.database == 'LIVE-VQC':
        videos_dir = '/home/jovyan/VSFA/Code/LIVEVQC/Video/'
        features_dir = 'CNN_features_LIVE-VQC/'
        datainfo = '/home/jovyan/VSFA/Code/LIVEVQC/data.mat'
    ...
    video_names = [Info[Info['video_names'][0, 0:9][i]][()].tobytes()[::2].decode() for i in range(len(Info['video_names'][0, 0:9]))]
    scores = Info['scores'][0, 0:9]
